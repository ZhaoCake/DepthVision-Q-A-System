...
class InternLM2(LLM):
    """InternLM2 LLM service."""

    model_name: str = Field(default="internlm2-chat-7b", alias="model")
    endpoint_url: str = "http://127.0.0.1:23333/v1/chat/completions"
    """Endpoint URL to use."""
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        """Call out to a InternLM2 LLM inference endpoint.
        ...
        logger.debug(f"InternLM2 payload: {payload}")
        ...
        logger.debug(f"InternLM2 response: {response}")
